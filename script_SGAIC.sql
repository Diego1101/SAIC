...
BEGIN
	...
	IF(@TIPO=3)
	BEGIN
		SELECT SR_ID ID, SR_ID_MQ MAQUINA, SR_TIPO TIPO, SR_PROBLEMA, SR_FECHA_INCIO INICIO, MQ_MODELO MODELO, RN_CALLE CALLE, RN_NUMERO NUM, RN_CIUDAD CIUDAD, RN_ESTADO ESTADO, RN_CP CP, CONCAT(CL_NOMBRE,' ' , CL_APELLIDO) NOMBRE
	...
	ELSE
	BEGIN
		SELECT SR_ID ID, SR_ID_MQ MAQUINA, SR_TIPO TIPO, SR_PROBLEMA, SR_FECHA_INCIO INCIO, MQ_MODELO MODEL, RN_CALLE CALLE, RN_NUMERO NUM, RN_CIUDAD CIUDAD, RN_ESTADO ESTADO, RN_CP CP, CONCAT(CL_NOMBRE,' ' , CL_APELLIDO) NOMBRE
		FROM SERVICIO A, MAQUINA B, RENTA C, VENTA D, CLIENTE E
...
ALTER PROCEDURE TSP_ListarTecnico
AS
BEGIN
...
ALTER procedure TSP_asignaServ
(
	@TECNICO	INT,
	@SERVICIO	INT
)
...
--
ALTER PROCEDURE TSP_ListarServicio
AS
BEGIN

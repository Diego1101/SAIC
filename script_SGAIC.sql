...
(
	...
	RF_MODELO	NVARCHAR(100) NOT NULL,
...
(
	...
	SR_FECHA_INCIO	DATETIME NOT NULL,
	SR_FECHA_FIN	DATETIME
)
GO
...
INSERT INTO RENTA(RN_ID_MAQUINA, RN_ID_VENTA, RN_FECHASERV) VALUES
	(6, 1, '2019-04-15'),
	(7, 2, NULL),
	(3, 2, NULL),
	(8, 2, NULL),
	(4, 3, '2019-04-16'), --TERMINADA
	(5, 4, '2019-04-17'), --ACTIVAS
	(4, 4, '2019-04-18')
GO
...
INSERT INTO SERVICIO(SR_ID_MAQUINA, SR_ID_EMPLEADO, SR_TIPO, SR_STATUS, SR_ESTADO, SR_DESCRIPCION, SR_FECHA_INCIO, SR_FECHA_FIN) VALUES
	...
	(6,3, 1, 1, 'LIGA-ESTADO', 'PROBLEMA CON LA TINTA', '2019-04-15', NULL)
GO
